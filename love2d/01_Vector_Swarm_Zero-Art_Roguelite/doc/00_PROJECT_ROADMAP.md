...
Phase 6  ▓▓▓░░░░░░░░  절차적 적 DNA 시스템 ← 진행 중 (6B ✅, 6A.1-2 ✅, 나머지 🔲)
```
...
| 6A.2 | Deity System v2 (Codex Scene) | ✅ | 신 정보 + 곡선 미리보기 + 스토리 연결 |
...
| 6D.2 | Codex 업적 연동 (잠금/해금) | 🔲 | achievementSystem과 연결, 해금 시 연출 (파티클+글로우), 곡선별 해금 조건 설계 |
| 6D.3 | Codex 복잡 곡선 감상 개선 | 🔲 | Butterfly 등 complexity 3: 속도 추가 감속 + 선 두께 세분화 |
