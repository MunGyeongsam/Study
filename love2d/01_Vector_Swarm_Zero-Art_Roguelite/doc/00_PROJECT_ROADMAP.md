...
| # | 작업 | 상태 | 비고 |
|---|------|------|------|
| 4A.1 | 메타 성장 (Data Fragment + 영구 강화 트리) | 🔲 | 죽어도 쌓이는 보상 → 핵심 리텐션 |
| 4A.2 | 해금 시스템 (도전과제 → 신규 무기/캐릭터) | 🔲 | 장기 목표 부여 |

### 4B. 플레이어 경험 (UX) — 게임의 "얼굴"
| # | 작업 | 상태 | 비고 |
|---|------|------|------|
| 4B.1 | 메뉴 / 일시정지 / 옵션 화면 | 🔲 | 타이틀, 볼륨, 해상도 |
| 4B.2 | 튜토리얼 (첫 30초 가이드) | 🔲 | 진입 장벽 제거 |
| 4B.3 | 크레딧 메뉴 (Paul Bourke 등) | 🔲 | 예의 + 완성도 |

### 4C. 비주얼 폴리싱 — Juice 마무리
| # | 작업 | 상태 | 비고 |
|---|------|------|------|
| 4C.1 | 구역 전환 연출 (배경색/톤 변화) | 🔲 | 기술부채 해소 |
| 4C.2 | 보스 처치 연출 풀 버전 (탄막→XP, 글리치 텍스트) | 🔲 | 기술부채 해소 |
| 4C.3 | 미니맵 (월드 내 위치 표시) | 🔲 | 선택적 |
...
| # | 작업 | 상태 | 비고 |
|---|------|------|------|
| 4E.1 | Android/iOS 빌드 + 터치 최적화 | 🔲 | 최종 단계 |
