...
> 마지막 갱신: 2026-04-20
> 현재 위치: **Phase 3 완료** — 보스 + 적 다양성 + 비주얼 이펙트 + 사운드. 다음: Phase 4 폴리싱 & 출시
...
| # | 작업 | 상태 | 비고 |
|---|------|------|------|
| 4D.1 | 밸런싱 & QA (전체 난이도 곡선 튜닝) | 🔲 | 4A 이후 |
...
| 5A.3a | 포메이션 시스템 (5종 대형) | 🔲 | Wedge, Pincer, Triangle, Escort, Spiral Array |
| 5A.3b | Swift 변형 (고속 소형) | 🔲 | 속도×1.5, 크기×0.8 + 잔상 렌더 |
| 5A.3c | Armored 변형 (고체력 대형) | 🔲 | HP×2.5, 속도×0.7 + 두꺼운 외곽선 |
| 5A.3d | Splitter 변형 (분열형) | 🔲 | 사망시 미니 2마리 분열 + 점선 외곽 |
| 5A.3e | Shielded 변형 (전방 방어) | 🔲 | 전방 90° 피탄 무효 + 방패 아크 |
| 5A.3f | STAGE_DEFS 확장 (변형+포메이션 배치) | 🔲 | 스테이지별 변형/포메이션 등장 타이밍 |
